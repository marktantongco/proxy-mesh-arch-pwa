...
| [`kiro-gateway`](https://github.com/marktantongco/kiro-gateway) | Kiro Gateway source | OpenAI-compatible API gateway (Layer 3b) |
| [`kiro-stack`](https://github.com/marktantongco/kiro-stack) | Unified installer | One-command setup for kiro-gateway + kirolink |
...
| [`kiro-owl-agent`](https://github.com/marktantongco/kiro-owl-agent) | OWL agent integration | OpenCode subagent model wiring |
| [`owl-agent-proxy`](https://github.com/marktantongco/owl-agent-proxy) | Proxy defense stack | Rate-limiting, caching, dedup |
